...
class PluginExecutioncontrolProfile extends Profile {
    ...
    static function displayTabContentForItem(CommonGLPI $item, $tabnum = 1, $withtemplate = 0) {
        ...
        if ($item->getType() == 'Profile') {
            ...
            self::addDefaultProfileInfos($ID,
                                            [
                                                'plugin_executioncontrol_tab'           => 0,
                                                'plugin_executioncontrol_devmistake'    => 0,
                                                'plugin_executioncontrol_exectime'      => 0,
                                                'plugin_executioncontrol_deadline'      => 0
                                            ]);
    ...
    static function createFirstAccess($ID) {
        ...
        self::addDefaultProfileInfos($ID,
                                        [
                                            'plugin_executioncontrol_tab'           => 3,
                                            'plugin_executioncontrol_devmistake'    => 3,
                                            'plugin_executioncontrol_exectime'      => 3,
                                            'plugin_executioncontrol_deadline'      => 3
                                        ]);
    ...
    static function getAllRights($all = false)
    {
        $rights = [
            ['rights' => [READ => __('Read'), UPDATE => __('Update')],
                'label' => 'Доступ к контролю',
                'field' => 'plugin_executioncontrol_tab'],
            ['rights' => [UPDATE => __('Update')],
                'label' => 'Ошибка разработчика',
                'field' => 'plugin_executioncontrol_devmistake'],
            ['rights' => [UPDATE => __('Update')],
                'label' => 'Время выполнения',
                'field' => 'plugin_executioncontrol_exectime'],
            ['rights' => [UPDATE => __('Update')],
                'label' => 'Соблюдение сроков',
                'field' => 'plugin_executioncontrol_deadline'],
        ];
